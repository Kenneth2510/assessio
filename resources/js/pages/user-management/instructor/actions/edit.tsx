...
type EditInstructorProps = {
    instructor: Instructor;
};

export default function EditInstructor({ instructor }: EditInstructorProps) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Edit',
            href: `/user-management/instructor/${instructor.id}/edit`,
        },
    ];
    ...
    const { data, setData, put, processing, errors } = useForm<InstructorFormData>({
    ...
    function handleInstructorSubmit(e: React.FormEvent<HTMLFormElement>) {
        e.preventDefault();
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <div>
                    <Button asChild>
                        <Link href={route('instructor.index')}>Back</Link>
                    </Button>
                </div>
                <div>
                    <Card>
                        <form onSubmit={handleInstructorSubmit} className="space-y-4">
                            <CardHeader>
                                ...
                                <CardDescription>Edit Instructor</CardDescription>
                            </CardHeader>
                            <CardContent>
